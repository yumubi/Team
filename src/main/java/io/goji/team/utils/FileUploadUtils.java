...
public class FileUploadUtils {
    ...
    public void setFileDir(String fileDir) {
        FileUploadUtils.fileDir = fileDir;
    }
    ...
    public static String upload(String subDir, MultipartFile file) {
        try {
            ...
            throw new ApiException(ResultCode.USER_UPLOAD_FILE_ERROR, e.getMessage());
        }
    }
    ...
    static void saveFileToLocal(MultipartFile file, String subDir, String fileName) throws IOException {
        if (StrUtil.isEmpty(subDir) || StrUtil.isEmpty(fileName)) {
            throw new ApiException(ResultCode.PARAM_ERROR, "subDir or fileName");
        }
    ...
    static String getRelativeFileUrl(String subDir, String fileName) {
        ...
        return StrUtil.format("/{}/{}/{}", RESOURCE_PREFIX, subDir, fileName);
    }
    ...
    static void isAllowedUpload(MultipartFile file, String[] allowedExtension) {
        ...
        if (fileNameLength > MAX_FILE_NAME_LENGTH) {
            throw new ApiException(ResultCode.PARAM_ERROR, String.valueOf(MAX_FILE_NAME_LENGTH));
        }

        long size = file.getSize();
        if (size > MAX_FILE_SIZE) {
            throw new ApiException(ResultCode.USER_UPLOAD_FILE_SIZE_EXCEEDS, String.valueOf(MAX_FILE_SIZE / MB));
        }

        String extension = getFileExtension(file);
        if (!isExtensionAllowed(extension, allowedExtension)) {
            throw new ApiException(ResultCode.USER_UPLOAD_FILE_ERROR,
    ...
    public static String getFileAbsolutePath(String subDir, String fileName) {
        return fileDir + File.separator + subDir + File.separator + fileName;
    }
